...
- `migrations/preliquidacion/` — SQL manual (ver §3), `ws1`…`ws16` (14 archivos; no existen `ws4` ni `ws6`) + `fix_trazabilidad_concepto_adicional.sql`. `docs/adr/` — decisiones. `CONTEXT.md` — glosario.
